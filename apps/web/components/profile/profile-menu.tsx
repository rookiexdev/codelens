          ...
          >
            ...
            <div className="border-t border-border py-1.5">
              <button
                ...
                className="flex w-full cursor-pointer items-center gap-2.5 px-4 py-2 text-left text-sm font-semibold text-danger transition hover:bg-danger/10 focus-visible:bg-danger/10 focus-visible:outline-none"
              >
                <LogOut
                  aria-hidden
                  className="h-4 w-4"
