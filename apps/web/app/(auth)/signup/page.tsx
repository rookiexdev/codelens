...
export default function SignupPage() {
  ...
  const onSubmit = async (values: RegisterInput): Promise<void> => {
    ...
    try {
      ...
      setFormError(
        extractApiError(err, "Could not create your account. Try again."),
      );
    }
  };
  ...
  return (
    <AuthShell
      ...
      brandTagline="Start in seconds"
      brandHeadline="A calmer way to read code."
      ...
      <form noValidate onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          {errors.password ? (
            ...
            <p className="text-xs text-fg-subtle">Use at least 8 characters.</p>
          )}
        </div>
